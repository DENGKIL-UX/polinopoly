...
function ViewToggle({ view, setView }: { view: '3d' | '2d'; setView: (v: '3d' | '2d') => void }) {
  return (
    <div className="absolute bottom-14 left-3 z-40 flex items-center gap-1 p-1 rounded-xl bg-slate-900/80 border border-slate-600/40 backdrop-blur-md shadow-lg">
      <button
        onClick={() => setView('3d')}
